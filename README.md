...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-argonr-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=2451&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-argonr-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-argonr` can be installed with:

```
conda install r-argonr
```

It is possible to list all of the versions of `r-argonr` available on your platform with:
